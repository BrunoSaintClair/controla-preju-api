...
public record CreatedRevenueView(UUID id, String title, String description,
    ...
    public CreatedRevenueView(Revenue revenue) {
        this(revenue.getId(), revenue.getTitle(), revenue.getDescription(),
                revenue.getAmountInCents(), revenue.getCategory(), revenue.getCreatedAt(), revenue.getStatus(), revenue.isAutomaticProcess());
    }
}
