...
public interface ExpenseJpaRepository extends JpaRepository<Expense, UUID> {
    ...
    List<Expense> findAllByUserIdAndPaymentMethod(@Param("userId") UUID userId, @Param("paymentMethod") PaymentMethod paymentMethod);
    ...
    List<Expense> findAllByAccountIdAndYearAndMonth(@Param("accountId") UUID accountId, @Param("year") int year, @Param("month") int month);
    ...
    List<Expense> findAllByAccountIdAndYearAndMonthAndDay(@Param("accountId") UUID accountId, @Param("year") int year, @Param("month") int month, @Param("day") int day);
