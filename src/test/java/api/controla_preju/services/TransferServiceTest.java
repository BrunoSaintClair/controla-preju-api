...
class TransferServiceTest {
    ...
    void setUp() {
        ...
        sourceAccount = new Account("Origem", "Conta de saída", AccountType.CONTA_CORRENTE, 2000L, true, user);
        ReflectionTestUtils.setField(sourceAccount, "id", UUID.randomUUID());

        destinationAccount = new Account("Destino", "Conta de entrada", AccountType.POUPANCA, 500L, true, user);
